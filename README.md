...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/misty-credit-0ebe)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/misty-credit-0ebe
```

A live public deployment of this template is available at [https://misty-credit-0ebe.templates.workers.dev](https://misty-credit-0ebe.templates.workers.dev)
